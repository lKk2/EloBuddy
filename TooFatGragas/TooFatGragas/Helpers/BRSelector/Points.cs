...
namespace BRSelector.Model
{
    internal class Points
    {
        ...
        static Points()
        {
            try
            {
                ...
                Items = new HashSet<Heroes>
                {
                    ...
                    new Heroes("gold", "Farming Machine", 3,
                        t => t.MinionsKilled + t.NeutralMinionsKilled*22.35f + t.ChampionsKilled*300f + t.Assists*95f)
                };
            }
            catch (Exception ex)
            {
        ...
        public static HashSet<Heroes> Items { get; set; }
